...
public class GreatSwordSkeleton_Skill4 : SkillBase
{
    ...
    public override void DoSpecialAction(CharacterRuntime user, CharacterRuntime target)
    {
    ...
    public override void OnFailCharge(CharacterRuntime user)
    {
        user.ApplyStatusEffect(paralysis, 1);
        user.ApplyStatusEffect(defDown, 1);
    }

    public override bool CheckSkillCondition(CharacterRuntime user)
    {
